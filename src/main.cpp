...
std::shared_ptr<Scene> makeCornellBoxScene() {
  ...
  scene->lights.push_back(
      std::make_shared<PointLight>(Vec3f(.275, .548, -.275), 1.5));
  ...
  auto red       = std::make_shared<Material>(Material{Vec3f(  1,  0,  0), {  .6,  .3,  .01,   0},  100,    1});
  auto green     = std::make_shared<Material>(Material{Vec3f(  0,  1,  0), {  .6,  .3,  .01,   0},   20,    1});
  auto yellow    = std::make_shared<Material>(Material{Vec3f(  1,  1,  0), {  .6,  .3,  .01,   0},  100,    1});
  auto white     = std::make_shared<Material>(Material{Vec3f(  1,  1,  1), {  .6,  .1,  .01,   0},   10,    1});
  auto mirror    = std::make_shared<Material>(Material{Vec3f(  1,  1,  1), {   0,  10,   .8,   0}, 1500,    1});
